...
class BabyBrainSegmentation(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "BabyBrainSegmentation" # TODO make this more human readable by adding spaces
...
class BabyBrainSegmentationLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('BabyBrainSegmentationTest-Start','MyScreenshot',-1)
