...
#include "GlobalContrastEnhancerCLP.h"
...
int DoIt( int argc, char * argv[], TPixel )
{
  ...
  if (algorithm=="Logistic") {
      ...
      filter->SetMaximumOutput( maximumScaling );
      filter->SetMinimumOutput( minimumScaling );
      filter->SetHigherCut( higherCut );
      filter->SetLowerCut( lowerCut );
      if (flipFunction) {
